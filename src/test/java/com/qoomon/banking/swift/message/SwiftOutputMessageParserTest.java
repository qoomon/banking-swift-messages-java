...
public class SwiftOutputMessageParserTest {
    ...
    public void parse_WHEN_detecting_whitespaces_between_blocks_THEN_throw_exception() throws Exception {
        ...
        // Given
        String swiftMessageText = BLOCK_1_DUMMY_VALID + BLOCK_2_DUMMY_VALID + "{3:}" + " " + BLOCK_4_DUMMY_EMPTY + "{5:}";
    ...
    public void parse_WHEN_first_bracket_is_missing_THEN_throw_exception() throws Exception {
        ...
        // Given
        String swiftMessageText = "1:}" + BLOCK_2_DUMMY_VALID + BLOCK_3_DUMMY_VALID+ BLOCK_4_DUMMY_EMPTY + "{5:}";
    ...
    public void parse_WHEN_block_appears_multiple_times_THEN_throw_exception() throws Exception {
        ...
        // Given
        String swiftMessageText = BLOCK_1_DUMMY_VALID + BLOCK_2_DUMMY_VALID + BLOCK_3_DUMMY_VALID+ BLOCK_4_DUMMY_EMPTY + "{5:}{1:}";
    ...
    public void parse_WHEN_unknown_block_appears_THEN_throw_exception() throws Exception {
        ...
        // Given
        String swiftMessageText = BLOCK_1_DUMMY_VALID  + BLOCK_2_DUMMY_VALID + BLOCK_3_DUMMY_VALID+ BLOCK_4_DUMMY_EMPTY + "{5:}{6:}";
